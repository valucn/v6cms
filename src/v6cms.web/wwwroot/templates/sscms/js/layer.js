!function (e, t) {
    ...
    var i, n, a = e.layui && layui.define, o = {
        ...
        link: function (t, i, n) {
            if (r.path) {
                ...
                s.rel = "stylesheet",
                    s.href = r.path + t,
                    s.id = l,
                    document.getElementById(l) || a.appendChild(s),
                    "function" == typeof i && function t() {
                        return ++f > 80 ? e.console && console.error("layer.css: Invalid") : void (1989 === parseInt(o.getStyle(document.getElementById(l), "width")) ? i() : setTimeout(t, 100))
                    }()
            }
        }
    }, r = {
        ...
        ready: function (e) {
            var t = "layer"
                , i = (a ? "modules/layer/" : "theme/") + "../../css/layer.css?v=" + r.v;
            return a ? layui.addcss(i, e, t) : o.link(i, e, t),
                this
        },
        ...
        msg: function (e, t, n) {
            ...
            return a && (n = t),
                r.open(i.extend({
                    ...
                    anim: c
                } : ((-1 === (t = t || {}).icon || void 0 === t.icon && !o.config.skin) && (t.skin = f + " " + (t.skin || "layui-layer-hui")),
                    t)))
        },
        load: function (e, t) {
    ...
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"],
            ...
            if (!t.id || !i("#" + t.id)[0]) {
                ...
                t.type) {
                    case 0:
                        ...
                        break;
                    case 2:
                        var c = t.content = s ? t.content : [t.content || "http://layer.layui.com", "auto"];
                ...
                if (e.vessel(s, function (n, r, u) {
                    f.append(n[0]),
                        s ? 2 == t.type || 4 == t.type ? i("body").append(n[1]) : c.parents("." + l[0])[0] || (c.data("display", c.css("display")).show().addClass("layui-layer-wrap").wrap(n[1]),
                            i("#" + l[0] + a).find("." + l[5]).before(r)) : f.append(n[1]),
                        i(".layui-layer-move")[0] || f.append(o.moveElem = u),
                        e.layero = i("#" + l[0] + a),
                    ...
                    2 == t.type && 6 == r.ie && e.layero.find("iframe").attr("src", c[0]),
        ...
        s.pt.auto = function (e) {
            var t = this.config
                , a = i("#" + l[0] + e);
            "" === t.area[0] && t.maxWidth > 0 && (r.ie && r.ie < 8 && t.btn && a.width(a.innerWidth()),
                a.outerWidth() > t.maxWidth && a.width(t.maxWidth));
            var o = [a.innerWidth(), a.innerHeight()]
                , s = a.find(l[1]).outerHeight() || 0
                , f = a.find("." + l[6]).outerHeight() || 0
                , c = function (e) {
                    (e = a.find(e)).height(o[1] - s - f - 2 * (0 | parseFloat(e.css("padding-top"))))
                };
            switch (t.type) {
                case 2:
                    c("iframe");
                    break;
                default:
                    "" === t.area[1] ? t.maxHeight > 0 && a.outerHeight() > t.maxHeight ? (o[1] = t.maxHeight,
                        c("." + l[5])) : t.fixed && o[1] >= n.height() && (o[1] = n.height(),
                            c("." + l[5])) : c("." + l[5])
            }
            return this
        }
        ...
        s.pt.tips = function () {
            ...
            e.tips[1] || s.remove(),
                r.autoLeft = function () {
                    r.left + a[0] - n.width() > 0 ? (r.tipLeft = r.left + r.width - a[0],
                        s.css({
                            right: 12,
                            left: "auto"
                        })) : r.tipLeft = r.left
                ...
                r.where = [function () {
                    ...
                    , function () {
                        r.tipLeft = r.left - a[0] - 10,
                            r.tipTop = r.top,
                            s.removeClass("layui-layer-TipsR").addClass("layui-layer-TipsL").css("border-bottom-color", e.tips[1])
                    }
                ],
                r.where[f - 1](),
                1 === f ? r.top - (n.scrollTop() + a[1] + 16) < 0 && r.where[2]() : 2 === f ? n.width() - (r.left + r.width + a[0] + 16) > 0 || r.where[3]() : 3 === f ? r.top - n.scrollTop() + r.height + a[1] + 16 - n.height() > 0 && r.where[0]() : 4 === f && a[0] + 16 - r.left > 0 && r.where[1](),
                t.find("." + l[5]).css({
        ...
        s.pt.callback = function () {
            var e = this
                ...
                , n = e.config;
            e.openLayer(),
                n.success && (2 == n.type ? t.find("iframe").on("load", function () {
                    n.success(t, e.index)
                }) : n.success(t, e.index)),
                6 == r.ie && e.IE6(t),
                t.find("." + l[6]).children("a").on("click", function () {
                    var a = i(this).index();
                    0 === a ? n.yes ? n.yes(e.index, t) : n.btn1 ? n.btn1(e.index, t) : r.close(e.index) : !1 === (n["btn" + (a + 1)] && n["btn" + (a + 1)](e.index, t)) || r.close(e.index)
                }),
                t.find("." + l[7]).on("click", function () {
                    !1 === (n.cancel && n.cancel(e.index, t)) || r.close(e.index)
                }),
                n.shadeClose && i("#layui-layer-shade" + e.index).on("click", function () {
                    r.close(e.index)
                }),
                t.find(".layui-layer-min").on("click", function () {
                    !1 === (n.min && n.min(t)) || r.min(e.index, n)
                }),
                t.find(".layui-layer-max").on("click", function () {
                    i(this).hasClass("layui-layer-maxmin") ? (r.restore(e.index),
                        n.restore && n.restore(t)) : (r.full(e.index, n),
                            setTimeout(function () {
                                n.full && n.full(t)
                            }, 100))
                }),
        ...
        r.close = function (e) {
            ...
            if (t[0]) {
                ...
                t.data("isOutAnim") && t.addClass("layer-anim layer-anim-close"),
                    ...
                    r.ie && r.ie < 10 || !t.data("isOutAnim") ? s() : setTimeout(function () {
                        s()
                    }, 200)
            }
        }
    ...
    r.prompt = function (e, t) {
        var a = "";
        if ("function" == typeof (e = e || {}) && (t = e),
            e.area) {
            var o = e.area;
            a = 'style="width: ' + o[0] + "; height: " + o[1] + ';"',
                delete e.area
        }
        var s, l = 2 == e.formType ? '<textarea class="layui-layer-input"' + a + ">" + (e.value || "") + "</textarea>" : '<input type="' + (1 == e.formType ? "password" : "text") + '" class="layui-layer-input" value="' + (e.value || "") + '">', f = e.success;
        ...
        r.photos = function (t, n, a) {
            ...
            if ((t = t || {}).photos) {
                ...
                o.imgprev = function (e) {
                    o.imgIndex--,
                        o.imgIndex < 1 && (o.imgIndex = f.length),
                        o.tabimg(e)
                }
                    ,
                    o.imgnext = function (e, t) {
                        o.imgIndex++,
                            o.imgIndex > f.length && (o.imgIndex = 1,
                                t) || o.tabimg(e)
                    }
                    ,
                    o.keyup = function (e) {
                        if (!o.end) {
                            var t = e.keyCode;
                            e.preventDefault(),
                                37 === t ? o.imgprev(!0) : 39 === t ? o.imgnext(!0) : 27 === t && r.close(o.index)
                        }
                    }
                    ,
                    o.tabimg = function (e) {
                        if (!(f.length <= 1))
                            return l.start = o.imgIndex - 1,
                                r.close(o.index),
                                r.photos(t, !0, e)
                    }
                    ,
