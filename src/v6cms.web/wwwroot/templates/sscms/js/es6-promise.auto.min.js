!function (t, e) {
    ...
    function u(e, n, i) {
        n.constructor === e.constructor && i === r && n.constructor.resolve === o ? function (t, e) {
            e._state === C ? f(t, e._result) : e._state === O ? l(t, e._result) : h(e, void 0, function (e) {
                return c(t, e)
            }, function (e) {
                return l(t, e)
            })
        }(e, n) : i === F ? (l(e, F.error),
            F.error = null) : void 0 === i ? f(e, n) : t(i) ? function (t, e, n) {
                w(function (t) {
                    var r = !1
                        , o = function (t, e, n, r) {
                            try {
    ...
    function f(t, e) {
        t._state === x && (t._result = e,
            t._state = C,
            0 !== t._subscribers.length && w(p, t))
    }
    function l(t, e) {
        t._state === x && (t._state = O,
            t._result = e,
            w(a, t))
    }
    function h(t, e, n, r) {
    ...
    function v(e, n, r, o) {
        ...
        if (i) {
            ...
            s = o,
                a = !0;
        n._state !== x || (i && a ? c(n, s) : h ? l(n, u) : e === C ? f(n, s) : e === O && l(n, s))
    }
    function d(t) {
        t[P] = Y++,
            t._state = void 0,
    ...
    var _ = Array.isArray ? Array.isArray : function (t) {
    ...
    M = S ? function () {
        ...
        : j ? function () {
            ...
            try {
                ...
                return void 0 !== (m = t.runOnLoop || t.runOnContext) ? function () {
                    m(n)
                }
                    : e()
            } catch (t) {
        ...
        , k = function () {
            function t(t, e) {
                this._instanceConstructor = t,
                    ...
                    this.promise[P] || d(this.promise),
                    _(e) ? (this.length = e.length,
                        this._remaining = e.length,
                        this._result = new Array(this.length),
                        0 === this.length ? f(this.promise, this._result) : (this.length = this.length || 0,
                            this._enumerate(e),
                            0 === this._remaining && f(this.promise, this._result))) : l(this.promise, new Error("Array Methods must be provided an Array"))
            }
            return t.prototype._enumerate = function (t) {
                ...
                t.prototype._eachEntry = function (t, e) {
                    ...
                    if (c === o) {
                        ...
                        this._willSettleAt(c(t), e)
                }
                ,
                t.prototype._settledAt = function (t, e, n) {
                    var r = this.promise;
                    r._state === x && (this._remaining--,
                        t === O ? l(r, n) : this._result[e] = n),
