!function (t) {
    ...
    return function t(e, n, i) {
        ...
        1: [function (t, e, n) {
            "use strict";
            var i, o = t("decouple"), s = t("emitter"), r = !1, a = window.document, u = a.documentElement, l = window.navigator.msPointerEnabled, h = {
                start: l ? "MSPointerDown" : "touchstart",
                move: l ? "MSPointerMove" : "touchmove",
                end: l ? "MSPointerUp" : "touchend"
            }, c = function () {
                var t = /^(Webkit|Khtml|Moz|ms|O)(?=[A-Z])/
                    , e = a.getElementsByTagName("script")[0].style;
                for (var n in e)
                    if (t.test(n))
            ...
            !function (t, e) {
                ...
                ,
                p.prototype._translateXTo = function (t) {
                    return this._currentOffsetX = t,
                        this.panel.style[c + "transform"] = this.panel.style.transform = "translateX(" + t + "px)",
                        this
                }
                ,
                ...
                p.prototype._initTouchEvents = function () {
                    var t = this;
                    return this._onScrollFn = o(a, "scroll", function () {
                        ...
                        this._onTouchMoveFn = function (e) {
                            if (!(r || t._preventOpen || void 0 === e.touches || function (t) {
                                for (; t.parentNode;) {
                                ...
                                if (!(Math.abs(i) > t._padding) && Math.abs(n) > 20) {
                                    ...
                                    t._moved || t.emit("translatestart"),
                                        o <= 0 && (i = n + t._padding * t._orientation,
                                            t._opening = !1),
                                        t._moved && u.classList.contains("slideout-open") || u.classList.add("slideout-open"),
                                        t.panel.style[c + "transform"] = t.panel.style.transform = "translateX(" + i + "px)",
                                        t.emit("translate", i),
                                        t._moved = !0
                                }
                            }
                ...
                return t.prototype.on = function (t, e) {
                    ...
                    t.prototype.emit = function (t) {
                        for (var e = this, n = arguments.length, i = Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++)
                            i[o - 1] = arguments[o];
                        var s = void 0;
                        return this._eventCollection && (s = this._eventCollection[t]) ? (s = s.slice(0),
